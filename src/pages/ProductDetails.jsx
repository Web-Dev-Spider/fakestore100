...
function ProductDetails() {
    ...
    return (
        ...
        <div>
            {
                isLoading ? (<div className='flex h-screen items-center'><LoadingIcon /></div>) : (<div className='grid grid-cols-1 md:grid-cols-3 p-2 md:p-4 flex-col md:flex-row gap-8 mt-3 justify-center items-center h-3/4 drop-shadow-xl w-3/4 mx-auto'>
